namespace Calculator_project.Exceptions
{
    ...
    internal class NumberTooLargeException : Exception
    {
        ...
        public NumberTooLargeException(string? message, Exception? innerException)
            : base(message, innerException)
        {
        }

        protected NumberTooLargeException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
